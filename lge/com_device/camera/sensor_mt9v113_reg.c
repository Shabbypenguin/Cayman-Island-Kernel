...
{
//	{0x301A, 0x1218},//2011-09-14	                              
//DELAY=100	//camera_timed_wait(50); //2007-12-03
//	{0xFFFF, 0x0064},//2011-09-14	     
//	{0x301A, 0x121C},//2011-09-14	     
//DELAY=100	                                                                                                               

//	{0xFFFF, 0x0064},//2011-09-14	     
	{0x0018, 0x4028}, // STANDBY_CONTROL  
//	{0x0018, 0x4000},// !=0, DELAY=10, TIMEOUT=100                     
//	{0x301A, 0x0004},// !=1, DELAY=50, TIMEOUT=20 // Verify streaming bit is high                                                                                                                             
};
...
//	{0xFFFF, 0x000A},   //2011-12-02 to fix the problem that color ordering is changed                                                                                                                                                                                           
//	{0x001A, 0x0018},   //2011-12-02 to fix the problem that color ordering is changed        
	...
	{0x0990, 0x0730},//{0x0990, 0x0398}, 	// MCU_DATA_0
	...
	{0x0990, 0x003F},//{0x0990, 0x007F}, 	// MCU_DATA_0
	...
	{0x0990, 0x004C},//{0x0990, 0x0098}, 	// MCU_DATA_0
...
//[20070806 tuned]
	...
	{0x0990, 0x0006},  // AE_GATE   {0x0990, 0x000A},  // AE_GATE                        
