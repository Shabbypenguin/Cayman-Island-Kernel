...
static int __init mipi_cmd_lgd_wvga_pt_init(void)
{
	int ret;
	...
	pinfo.wait_cycle = 0;
	pinfo.bpp = 24;
	pinfo.lcdc.h_back_porch = 15;//64;//80;//16;
	pinfo.lcdc.h_front_porch = 5;//48;//16;
	pinfo.lcdc.h_pulse_width = 3;//32;//10;
...
module_init(mipi_cmd_lgd_wvga_pt_init);
