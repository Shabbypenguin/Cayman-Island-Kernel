...
#if defined (CONFIG_LGE_WIRELESS_CHARGER_MAX8971) || defined (CONFIG_LGE_BROADCAST) || defined (CONFIG_LGE_WIRELESS_CHARGER_BQ24160)
#else
...
static struct gpiomux_setting moter_en_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
#ifdef CONFIG_LGE_SENSOR //2011.02.14 woochang.chun, for gpio conflict
#else
...
static struct msm_gpiomux_config msm8x60_audio_configs[] __initdata = {
	/* MOTOR_EN*/
	{
		...
		.settings = {
			[GPIOMUX_SUSPENDED] = &moter_en_cfg,
		}
	},
        /* LIN_MOTOR_PWM*/
	{
