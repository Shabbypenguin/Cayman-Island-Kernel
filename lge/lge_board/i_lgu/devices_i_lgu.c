...
struct clk_lookup msm_clocks_8x60[] = {
...
#elif defined (CONFIG_LGE_BROADCAST)
	CLK_8X60("spi_clk",	GSBI11_QUP_CLK,	"spi_qsd.2"/*&msm_gsbi1_qup_spi_device.dev*/, OFF),
#else
	...
	CLK_8X60("gsbi_qup_clk",	GSBI11_QUP_CLK,"qup_i2c.12",OFF),
#elif defined (CONFIG_LGE_BROADCAST)
	CLK_8X60("spi_pclk",	GSBI11_QUP_CLK,	"spi_qsd.2"/*&msm_gsbi1_qup_spi_device.dev*/, OFF),
#else
