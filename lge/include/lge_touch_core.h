...
struct baseline_ctrl {
	volatile int keyguard;				// keyguard = 1, unlock = 0
	unsigned int state;
	unsigned int ghost_check_count;
	struct timeval press_start;
	struct timeval release;
};
