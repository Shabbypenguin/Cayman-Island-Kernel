...
int lge_get_kernel_shutdown_nofityed(void) 
 { 
         int is_kernel_shutdown_notified = -1; 
         ...
         { 
                 ...
                 //case SYSTEM_POWER_OFF: 
                         ...
                         break; 
		     default : 
                         is_kernel_shutdown_notified = 0; 
                         break; 
		} 
         return is_kernel_shutdown_notified; 
 } 
EXPORT_SYMBOL_GPL(lge_get_kernel_shutdown_nofityed); 
#endif
...
// LGE_S kiwone.seo@lge.com 2010-05-01, to view log from android */
		printk(KERN_ERR"%s: sys_reboot is called from android\n",__func__);
		printk(KERN_ERR"%s: reboot cmd is %d\n", __func__, cmd);
/* LGE_E kiwone.seo@lge.com */
