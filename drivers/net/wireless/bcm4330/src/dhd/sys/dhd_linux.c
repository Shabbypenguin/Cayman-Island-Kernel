...
//uint dhd_watchdog_ms = 1000; //nezzimom0927
uint dhd_watchdog_ms = 20; //revert 
...
static int dhd_set_suspend(int value, dhd_pub_t *dhd)
{
	...
	if (dhd && dhd->up) {
		if (value && dhd->in_suspend) {
				...
				//bill.jung@lge.com - For turning down Clock //nezzimom0927
				//dhd_os_sdlock(dhd);
				{
					int i=0;
					for( i=0; i<5; i++)
...
/* LGE_CHANGE_S [yoohoo@lge.com] 2009-03-05, for gpio set in dhd_linux */
    ...
    //LGE_VERIZON_WIFI_S, [kyubyoung.lee@lge.com], 2011.06.25, for Direct crash
	...
	//LGE_VERIZON_WIFI_E, [kyubyoung.lee@lge.com], 2011.06.25, for Direct crash
