...
/* LGE_CHANGE_E [yoohoo@lge.com] 2009-08-27, roam_off, PM */
	...
	int arp_ol = 0xc;
#else
// LGE_VERIZON_WIFI_S, [kyubyoung.lee@lge.com], 2011.08.25, changed an wrong arp offroad option to correct option 
   //int arp_ol = 0xf;
   int arp_ol = 0xb;
// LGE_VERIZON_WIFI_E, [kyubyoung.lee@lge.com], 2011.08.25, changed an wrong arp offroad option to correct option 
#endif /* WLBTAMP */
